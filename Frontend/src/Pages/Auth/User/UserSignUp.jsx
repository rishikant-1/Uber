    ...
    <div className='w-full h-screen flex flex-col justify-between'>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className='px-5 flex flex-col gap-4 py-6'>
        ...
        <div className='grid grid-cols-2 gap-3'>
          <div>
            <span className='font-semibold text-xl flex mb-1'>First Name</span>
            <input
          ...
          <div>
            <span className='font-semibold text-xl flex mb-1'>Last Name</span>
            <input
              className='p-2 text-xl w-full rounded-md bg-gray-200 border border-gray-300'
              type="text"
        ...
        <div>
          <span className='font-semibold text-xl flex mb-1'>Confirm Password</span>
          <input
            className='p-2 text-xl w-full rounded-md bg-gray-200 border border-gray-300'
            type="password"
        ...
        <div className='flex items-center justify-center gap-2'>
          <p>Login User</p>
          <Link to="/user-login" className='text-blue-500 hover:underline'>Login User</Link>
        </div>
      </form>
